...
def g():
    ...
    X_train, y_train = feature_view.training_data() #(training_dataset_version=1) #.train_test_split(0.2)
    ...
    y_train, y_test = feature_view.training_data()#(training_dataset_version=1) #.train_test_split(0.2)
